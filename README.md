...
- [Для поставщиков подписок](#для-поставщиков-подписок)
- [Дизайн](#дизайн)
...
Текущая версия — **Tunnel 0.15.0**. Это большое техническое обновление: подписки переведены на современную модель с Mihomo, старый путь обработки больше не является основным. Tunnel теперь работает не только с отдельными нодами, но и с полными Clash/Mihomo-профилями — группами, правилами, providers и другими поддерживаемыми разделами конфигурации.
