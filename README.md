...
<p align="center">
  Xray/VLESS · готовые маршруты · проверка серверов · failover · DPI / whitelist-oriented logic · Smart Connect 2.0<br /><br />
...
Текущая версия Tunnel-0.8.1. Результатом обновления стало повышение отклика при Белых Списках до 99.999%. 
